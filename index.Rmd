...
versjon <- data.frame(Dato = c("22.apr 2022", "22.apr 2022", "23.apr 2022"),
                            Endring = c("Grunnversjon", "Lagt til kapittel om regresjonsanalyse", "Oppdatert kode embedding av filer. Korrektur. Endret på rekkefølge to delkapitler."))
