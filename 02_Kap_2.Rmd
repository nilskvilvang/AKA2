...
pacman::p_load(car, readxl, effects, ggplot2, writexl, ggpubr, tidyverse, gridExtra, nortest, knitr, kableExtra, tseries, normtest, flextable, magrittr, ISLR, olsrr, lmtest, rnorsk, qwraps2, sjPlot, sjmisc, sjlabelled, xtable, Hmisc, gt, gtsummary, sjPlot, modelsummary, table1, jtools, interactions, outliers, EnvStats, qqplotr)
```
...
```{r}
par(mfrow=(c(1,2)))
qqSales2 <- qqPlot(Field_OLS_data$Adverts)
qqAdverts2 <- qqPlot(Field_OLS_data$Sales)
```
